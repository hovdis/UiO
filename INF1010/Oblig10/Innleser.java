...
public class Innleser {
    ...
    public void lesInnFil() throws Exception {
        try {
            ...
            brett.opprettDatastruktur(this);
        } catch (FileNotFoundException e) {
            System.out.println("Fila blei itte funne");
        }
    }
    ...
    public void skrivBrettFinnAlleMulige() {
        brett.printfinnAlleMulige();
    }
    public void SkrivBrettFinnAlleMuligeEnRute() {
        brett.finnAlleMuligeEnRute();
    }
    public void skrivUtBrett(){
